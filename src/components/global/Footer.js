...
const Footer = () => {
  return (
    // <footer classNameName="p-16 sm:p-12 bg-gray-800">
    ...
    //         <div>
    //           <h2 classNameName="mb-6 text-sm font-semibold uppercase text-white">
    //             Resources
    //           </h2>
    //           <ul classNameName=" text-gray-400">
    ...
    //       </div>
    //     </div>
    //     <hr classNameName="my-6  sm:mx-auto border-gray-700 lg:my-8" />
    //     <div classNameName="sm:flex sm:items-center sm:justify-between">
    //       <span classNameName="text-sm sm:text-center text-gray-400">
    //         © 2022{" "}
    //         <a href="https://flowbite.com" classNameName="hover:underline">
    //           AutoCS™
    //         </a>
    //         . All Rights Reserved.
    //       </span>
    //       <div classNameName="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
    //         <a href="#" classNameName="text-gray-500  hover:text-white">
    //           <svg
    ...
    //           </svg>
    //         </a>
    //         <a href="#" classNameName="text-gray-500  dark:hover:text-white">
    //           <svg
    //             classNameName="w-5 h-5"
    //             fill="currentColor"
    //             viewBox="0 0 24 24"
    ...
    //   </div>
    // </footer>
    <footer className="md:flex md:items-center md:justify-between px-14 pt-10 ">
      <p className="text-sm text-center text-gray-500 mb-4 md:mb-0">
        &copy; 2019-
        <a
          href="{{ .Site.Params.homepage }}/"
