...
const AssetTable = ({ isOpen }) => {
  ...
  return (
    <div className=" bg-white rounded-lg shadow  block ">
                      ...
                      {assets?.length > 0 &&
                        assets.map((asset) => (
                          <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td className="p-4 max-w-md overflow-hidden text-base font-normal text-gray-500 truncate dark:text-gray-400">
